 ...
 */
final class Version20240316091938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD user_id INT NOT NULL, CHANGE in_stock in_stock INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP user_id, CHANGE in_stock in_stock INT DEFAULT 0 NOT NULL');
    }
}
